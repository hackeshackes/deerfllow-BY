...
import { BookmarkPlusIcon, LoaderIcon, SparklesIcon } from "lucide-react";
          ...
          {showActions && (
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                ...
                size="sm"
                onClick={() => {
                  toast.success(t.common.captureWorkflowSuccess);
                }}
                disabled={!summary}
              >
              ...
              <Button
                ...
                size="sm"
                onClick={() => {
                  toast.success(t.common.captureAutomationSuccess);
                }}
                disabled={!summary}
              >
